...
public class Server implements ActionListener {
    ...
    Server(){
        ...
        /* used for closing the frame with on click event in arrow icon */
        ...
        JLabel norevert=new JLabel(i15);
        norevert.setBounds(420,20,10,25);
        jp.add(norevert);
        ...
        f.setSize(450,700);
        /*opening of frame from  given location */
        ...
        /*by default frame is not visible we need to set property as true*/
        f.setVisible(true);
    }
